  ...
  return (
    <div className="about-page page">
      <header className="page-header">
        <h1> The Future of Estonian Folk Clothing </h1>
      </header>
      <div className="page-content">
        <h2>When thinking on a possible future I think of cultural practices that can be passed from generation to generation</h2>
        <p><strong>Thesis:</strong></p> 
<p> My concept was to explore the future of Estonian culture in an environment overrun by technology, where folk culture and clothing are trying to remain relevant, examining the phenomenon of traditional cultures battling negligibility in the modern day, and speculating on the concept of human rituals adapting to a tech-centered reality.
